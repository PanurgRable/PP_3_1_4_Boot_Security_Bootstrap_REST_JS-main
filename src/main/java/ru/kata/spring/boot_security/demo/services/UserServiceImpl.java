...
public class UserServiceImpl implements UserService {
    ...
    public void saveUser(User user, String[] roles) {
        ...
        if (roles != null) {
            ...
            user.getRoles().forEach(role -> roleSet.add(roleService.findRoleByAuthority(role.getAuthority())));
        }
    ...
    public void updateUser(Long id, User user, String[] roles) {
        ...
        encodeUserPassword(userDb);
        System.out.println("UPD:" + userDb);
